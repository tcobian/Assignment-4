...
lobster_col <- ggplot(site_summary, aes(x = SITE, y = mean)) +
  ...
  annotate("text", x = 4, y = 86, label = "B", family = "Times New Roman") +
  annotate("text", x = 5, y = 93, label = "C", family = "Times New Roman") +
...
lobster_box <- ggplot(lobster_2, aes(x = SITE, y = SIZE))+
  ...
  annotate("text", x = 4, y = 120, label = "B", family = "Times New Roman") +
  annotate("text", x = 5, y = 140, label = "C", family = "Times New Roman")
