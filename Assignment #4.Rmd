...
# Experimental Code to get the letters above the graph..... NOT WORKING.... ignore this...
...
LABELS=generate_label_df(TUKEY , "SITE")
...
experiment = boxplot(lobster_2$SIZE ~ lobster_2$SITE, ylim=c(min(lobster_2$SIZE) , 1.1*max(lobster_2$SIZE)) , col=my_colors[as.numeric(LABELS[ , 1])] , ylab="Lobster Size" , main="Site")
